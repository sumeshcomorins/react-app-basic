...
export default function ExpenseFileUpload () {
  ...
  const [file, setFile] = useState();
    ...
    const onFileUpload = async() => {
      ...
      formData.append( 'request', 'expenseFileUploadRegister' )
      ...
      formData.append( 'userId', userId )
        ...
        .then( function ( response ) {
            console.log( 'expensefileuploadresponse', response )
...
<div style={{ textAlign: "center" }}>
            <h3 className="text-center" style={{marginTop:10}}><b>Expense FileUpload</b></h3>
            <form>
                <input
